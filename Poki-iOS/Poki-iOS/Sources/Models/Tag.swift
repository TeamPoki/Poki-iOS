...
struct TagData {
    static let data: [TagModel] = [
        ...
        TagModel(tagLabel: "플레이인더박스", tagImage: "https://firebasestorage.googleapis.com/v0/b/poki-ios-87d7e.appspot.com/o/Brand%2FFrame%2061148.png?alt=media&token=fa0b9582-98b7-4f29-bf35-aa054fc1b7b7"),
